...
public class InboundRequestFeeder extends ChannelOutboundHandlerAdapter {
    ...
    private void _sendMessages(ChannelHandlerContext ctx) {
        ...
        while (true) {
            ...
            MaxBytesRecvByteBufAllocator recvByteBufAllocator = ctx.channel().config().getRecvByteBufAllocator();
            if (sentInThisIteration >= recvByteBufAllocator.maxBytesPerRead()) {
