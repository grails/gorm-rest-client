...
class MediaType implements CharSequence {
    ...
    public static final MediaType HTML = new MediaType('text/html', "html")
    ...
    public static final MediaType JSON = new MediaType('application/json', "json")
    public static final MediaType TEXT_XML = new MediaType('text/xml', "xml")
    public static final MediaType TEXT_JSON = new MediaType('text/json', "json")
    public static final MediaType HAL_JSON = new MediaType('application/hal+json', "json")
    public static final MediaType HAL_XML = new MediaType('application/hal+xml', "xml")
